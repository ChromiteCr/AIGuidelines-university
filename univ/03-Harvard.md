# Harvard: Official AI Use Guidelines — Source Text

- Accessed: 2026-08-21
- Format note: Text extracted from official Harvard webpages; navigation and site chrome removed. Wording is retained; layout may differ from the webpage.
- Scope note: Combines an HGSE student policy with university-wide Provost guidance; HGSE-specific requirements are not presented as rules for every Harvard school.
...
- Official source: https://registrar.gse.harvard.edu/learning/policies-forms/ai-policy
- Domain: registrar.gse.harvard.edu
...
## University-wide Guidelines for Using ChatGPT and Other Generative AI Tools

- Official source: https://provost.harvard.edu/guidelines-using-chatgpt-and-other-generative-ai-tools-harvard
- Domain: provost.harvard.edu

---

Harvard supports responsible experimentation with generative AI tools, but identifies important considerations including information security and data privacy, compliance, copyright, and academic integrity.

### Initial guidelines for use of generative AI tools

- **Protect confidential data:** Do not enter data classified as confidential (Level 2 and above), including non-public research data, into publicly available generative AI tools. Information shared with generative AI tools using default settings is not private and could expose proprietary or sensitive information to unauthorized parties.
- **You are responsible for any content that you produce or publish that includes AI-generated material:** AI-generated content can be inaccurate, misleading, or entirely fabricated (“hallucinations”), or may contain copyrighted material. Review AI-generated content before publication.
- **Adhere to current policies on academic integrity:** Review the relevant School’s student and faculty handbooks and policies. Faculty should be clear with students about permitted uses, if any, of generative AI in classes and academic work. Students are encouraged to ask instructors for clarification as needed.
- **Be alert for AI-enabled phishing:** Generative AI has made sophisticated scams easier to create at scale. Continue to follow security best practices and report suspicious messages.
- **Connect with HUIT before procuring generative AI tools:** Tools procured on behalf of Harvard should have appropriate privacy and security protections. Vendor generative AI tools must be assessed for risk by Harvard’s Information Security and Data Privacy office before use.

Harvard notes that these guidelines are not new University policy; rather, they apply existing University policies to generative AI.